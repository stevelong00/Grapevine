...
namespace Grapevine.Common
{
    ...
    {
        private static readonly ConcurrentDictionary<HttpStatusCode, string> StatusCodeText;

        static HttpStatusCodes()
        {
            StatusCodeText = new ConcurrentDictionary<HttpStatusCode, string>();

            foreach (var statusCode in Enum.GetValues(typeof(HttpStatusCode)).Cast<HttpStatusCode>())
            {
                StatusCodeText[statusCode] = statusCode.ToString().ConvertCamelCase();
            }
        }
        ...
        public static string ConvertToString(this HttpStatusCode statusCode)
        {
        ...
        /// <param name="statusCode"></param>
        /// <returns></returns>
        public static int ToInteger(this HttpStatusCode statusCode)
        {
